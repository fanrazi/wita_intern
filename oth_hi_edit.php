  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Health & Insurance</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="index.php?halaman=oth_hi">Health & Insurance</a></li>
			...
			<div class="row">
				<div class="col-sm-6 offset-sm-3">
					<div class="form-group">
						...
						<input type="text" name="hi_nama" class="form-control" value="<?php echo $pecah['nama_hi'];?>" required="true">
					</div>
          <div class="form-group">
    ...
    <?php 
        if (isset($_POST['update']))
        {
          ...
          $path = "file others/hi/".$nama_file;

          if(!empty($lokasi))
          {
            $koneksi->query("UPDATE hi SET nama_hi='$_POST[hi_nama]',
          ...
          {
            $koneksi->query("UPDATE hi SET nama_hi='$_POST[hi_nama]' WHERE id='$_GET[id]'");
          }  
          echo "<div class='alert alert-info'>Data Telah Diubah</div>";
          echo "<meta http-equiv='refresh' content='1;url=index.php?halaman=oth_hi'>";
        }  
      ?>
      <a href="index.php?halaman=oth_hi">
