  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">South Africa</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <table id="example" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            ...
            <?php $ambil = $koneksi->query("SELECT * FROM tour JOIN outbound
                        ON tour.id=outbound.id_tou WHERE outbound.id_tou=4");?>
            ...
            <tr>
              ...
              <td>
                <a href="index.php?halaman=tou_sa_edit&id=<?php echo $pecah['id']; ?>">
                  <button class="btn btn-success btn-sm"> <i class="fa fa-edit"></i></button>
                </a>
                <a href="index.php?halaman=tou_sa_del&id=<?php echo $pecah['id']; ?>">
