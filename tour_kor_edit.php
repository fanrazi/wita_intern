  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Korea Tour</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <?php 
        if (isset($_POST['update']))
        {
          ...
          if(!empty($lokasi))
          {
            $koneksi->query("UPDATE outbound SET nama_t='$_POST[t_nama]', id_mas='7',
          ...
          {
            $koneksi->query("UPDATE outbound SET nama_t='$_POST[t_nama]', id_mas='7' WHERE id='$_GET[id]'");
          }  
          echo "<div class='alert alert-info'>Data Telah Diubah</div>";
          echo "<meta http-equiv='refresh' content='1;url=index.php?halaman=tou_kor'>";
        }  
      ?>
      <a href="index.php?halaman=tou_kor">
