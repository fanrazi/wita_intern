  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              ...
              <li class="breadcrumb-item active"><a href="index.php?halaman=h_p">Promo</a></li>
    ...
    <?php 
        if (isset($_POST['update']))
        {
          ...
          if(!empty($lokasi))
          {
            $koneksi->query("UPDATE promo SET nama_p='$_POST[p_nama]',
          ...
          {
            $koneksi->query("UPDATE promo SET nama_p='$_POST[p_nama]' WHERE id='$_GET[id]'");
          }  
          echo "<div class='alert alert-info'>Data Telah Diubah</div>";
          echo "<meta http-equiv='refresh' content='1;url=index.php?halaman=h_p'>";
        }  
      ?>
      <a href="index.php?halaman=h_p">
