<?php 
  $ambil = $koneksi->query("SELECT * FROM tp WHERE id='$_GET[id]'");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Theme Park</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="index.php?halaman=oth_tp">Theme Park</a></li>
              <li class="breadcrumb-item active">Edit Theme Park</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <?php 
        if (isset($_POST['update']))
        {
          ...
          $path = "file others/tp/".$nama_file;

          if(!empty($lokasi))
          {
            $koneksi->query("UPDATE tp SET nama_tp='$_POST[tp_nama]',
          ...
          {
            $koneksi->query("UPDATE tp SET nama_tp='$_POST[tp_nama]' WHERE id='$_GET[id]'");
          }  
          echo "<div class='alert alert-info'>Data Telah Diubah</div>";
          echo "<meta http-equiv='refresh' content='1;url=index.php?halaman=oth_tp'>";
        }  
      ?>
      <a href="index.php?halaman=oth_tp">
