  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="index.php?halaman=ecomm">E-Commerce</a></li>
    ...
    if (isset($_POST['simpan']))
    {
      ...
      echo "<meta http-equiv='refresh' content='1;url=index.php?halaman=eco'>";
    }
    
    ?>
    
    <a href="index.php?halaman=eco">
