  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Travel Fair</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
			...
			<div class="row">
				<div class="col-sm-6 offset-sm-3">
					<div class="form-group">
						...
						<input type="text" name="f_nama" class="form-control" required="true">
					</div>
          <div class="form-group">
						<label>File :</label>
    ...
    if (isset($_POST['simpan']))
    {
      ...
      $koneksi->query("INSERT INTO fair (nama_f, nama_file, file)
             VALUES ('$_POST[f_nama]', '$nama[0]', '$path')");
