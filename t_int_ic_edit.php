  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="index.php?halaman=t_int_ic">Iceland</a></li>
    ...
    <?php 
        if (isset($_POST['update']))
        {
          ...
          echo "<meta http-equiv='refresh' content='1;url=index.php?halaman=t_int_ic'>";
        }  
      ?>
      <a href="index.php?halaman=t_int_ic">
