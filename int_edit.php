  ...
  <div class="content-wrapper">
			...
			<div class="row">
				<div class="col-sm-6 offset-sm-3">
					<div class="form-group">
						...
						<input type="text" name="i_nama" class="form-control" value="<?php echo $pecah['nama_int'];?>" required="true">
					</div>
					<div class="form-group">
    ...
    <?php 
        if (isset($_POST['update']))
        {
          ...
          $koneksi->query("UPDATE internasional SET nama_int='$nama' WHERE id='$_GET[id]'");
          
          echo "<div class='alert alert-info'>Data Telah Diubah</div>";
          echo "<meta http-equiv='refresh' content='1;url=index.php?halaman=int'>";
        }
      ?>
      <a href="index.php?halaman=int">
