  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Transport</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <?php 
        if (isset($_POST['update']))
        {
          ...
          if(!empty($lokasi))
          {
            $koneksi->query("UPDATE trans SET nama_tr='$_POST[tr_nama]',
          ...
          {
            $koneksi->query("UPDATE trans SET nama_tr='$_POST[tr_nama]' WHERE id='$_GET[id]'");
          }  
