  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ticket Domestic</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
				...
				<div class="col-sm-6 offset-sm-3">
					<div class="form-group">
						...
						<select name="air" class="form-control" required="true">
							...
							<?php
              $ambil = $koneksi->query("SELECT * FROM maskapai ORDER BY nama_m ASC");
              while($city = $ambil->fetch_assoc()){
                ?>
                <Option value="<?php echo $city['id'];?>">
                  <?php echo $city['nama_m'];?>
                </Option>
              <?php }?>
						</select>
					</div>
    ...
    if (isset($_POST['simpan']))
    {
      ...
      $koneksi->query("INSERT INTO tiket_dom (nama_t, id_mas, nama_file, file)
             VALUES ('$_POST[t_nama]', '$_POST[air]', '$nama[0]', '$path')");
      
      move_uploaded_file($lokasi, $path);

      echo "<div class='alert alert-info'>Data Tersimpan</div>";
      echo "<meta http-equiv='refresh' content='1;url=index_tic.php?halaman=t_dom'>";
    }
