<?php 
  $ambil = $koneksi->query("SELECT * FROM tiket_dom WHERE id='$_GET[id]'");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Lion / Batik Ticket</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="index_tic.php?halaman=t_dom">Domestic Ticket</a></li>
              <li class="breadcrumb-item active"><a href="index_tic.php?halaman=t_dom_gar">Garuda</a></li>
    ...
    <?php 
        if (isset($_POST['update']))
        {
          ...
          $path = "file tiket/dom/".$nama_file;

          if(!empty($lokasi))
          {
            $koneksi->query("UPDATE tiket_dom SET nama_t='$_POST[t_nama]', id_mas='2',
          ...
          {
            $koneksi->query("UPDATE tiket_dom SET nama_t='$_POST[t_nama]', id_mas='2' WHERE id='$_GET[id]'");
          }  
          echo "<div class='alert alert-info'>Data Telah Diubah</div>";
          echo "<meta http-equiv='refresh' content='1;url=index_tic.php?halaman=t_dom_lio'>";
        }  
      ?>
      <a href="index_tic.php?halaman=t_dom_lio">
