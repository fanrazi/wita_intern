  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Lion</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Lion</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <table id="example" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            ...
            <?php $ambil = $koneksi->query("SELECT * FROM maskapai JOIN tiket_dom
                        ON maskapai.id=tiket_dom.id_mas WHERE tiket_dom.id_mas=2");?>
            ...
            <tr>
              ...
              <td>
                <a href="index_tic.php?halaman=t_dom_lio_edit&id=<?php echo $pecah['id']; ?>">
                  <button class="btn btn-success btn-sm"> <i class="fa fa-edit"></i></button>
                </a>
                <a href="index_tic.php?halaman=t_dom_lio_del&id=<?php echo $pecah['id']; ?>">
