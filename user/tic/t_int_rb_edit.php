  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Royal Brunei Ticket</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="index_tic.php?halaman=t_int_rb">Royal Brunei</a></li>
    ...
    <?php 
        if (isset($_POST['update']))
        {
          ...
          if(!empty($lokasi))
          {
            $koneksi->query("UPDATE tiket_int SET nama_t='$_POST[t_nama]', id_mas='31',
          ...
          {
            $koneksi->query("UPDATE tiket_int SET nama_t='$_POST[t_nama]', id_mas='31' WHERE id='$_GET[id]'");
          }  
          echo "<div class='alert alert-info'>Data Telah Diubah</div>";
          echo "<meta http-equiv='refresh' content='1;url=index_tic.php?halaman=t_int_rb'>";
        }  
      ?>
      <a href="index_tic.php?halaman=t_int_rb">
