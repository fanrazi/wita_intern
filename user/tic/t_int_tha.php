  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Thai Airways</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Thai</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <table id="example" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            ...
            <?php $ambil = $koneksi->query("SELECT * FROM airlines JOIN tiket_int
                        ON airlines.id=tiket_int.id_mas WHERE tiket_int.id_mas=6");?>
            ...
            <tr>
              ...
              <td>
                <a href="index_tic.php?halaman=t_int_tha_edit&id=<?php echo $pecah['id']; ?>">
                  <button class="btn btn-success btn-sm"> <i class="fa fa-edit"></i></button>
                </a>
                <a href="index_tic.php?halaman=t_int_tha_del&id=<?php echo $pecah['id']; ?>">
