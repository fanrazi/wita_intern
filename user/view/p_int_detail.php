<?php
$ambil = 
    $koneksi->query("SELECT * FROM internasional JOIN paket_int
        ON internasional.id=paket_int.id_city
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Package <?php echo $detail ['nama_int'];?> Detail</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="index_coun.php?halaman=p_int">International</a></li>
    ...
    <section class="content">
      ...
      <table id="example" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody> 
          <?php $nomor=1;?>
          <?php $ambil = $koneksi->query("SELECT * FROM internasional JOIN paket_int
                        ON internasional.id=paket_int.id_city WHERE internasional.id='$_GET[id]'");?>
      ...
      <a href="index_coun.php?halaman=p_int">
