  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      <a href="index_mar.php?halaman=mar_add">
      ...
      <table id="example" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            <?php $nomor=1;?>
            <?php $ambil = $koneksi->query("SELECT * FROM marketing ORDER BY nama_m ASC");?>
            ...
            <tr>
              ...
              <td>
                <a href="index_mar.php?halaman=mar_edit&id=<?php echo $pecah['id']; ?>">
                  <button class="btn btn-success btn-sm"> <i class="fa fa-edit"></i></button>
                </a>
                <a href="index_mar.php?halaman=mar_del&id=<?php echo $pecah['id']; ?>">
