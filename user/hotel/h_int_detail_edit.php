<?php 
  $ambil = $koneksi->query("SELECT * FROM hotel_int WHERE id='$_GET[id]'");
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="index_hot.php?halaman=h_int">International</a></li>
    ...
    <?php 
        if (isset($_POST['update']))
        {
          ...
          $path = "file internasional/hotel/".$nama_file;

          if(!empty($lokasi))
          {
            $koneksi->query("UPDATE hotel_int SET nama_h='$_POST[h_nama]',
          ...
          {
            $koneksi->query("UPDATE hotel_int SET nama_h='$_POST[h_nama]' WHERE id='$_GET[id]'");
          }  
          echo "<div class='alert alert-info'>Data Telah Diubah</div>";
          echo "<meta http-equiv='refresh' content='1;url=index_hot.php?halaman=h_int'>";
        }  
      ?>
      <a href="index_hot.php?halaman=h_int">
