<?php 
  $ambil = $koneksi->query("SELECT * FROM passport WHERE id='$_GET[id]'");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Passport</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
			...
			<div class="row">
				<div class="col-sm-6 offset-sm-3">
					<div class="form-group">
						...
						<input type="text" name="v_nama" class="form-control" value="<?php echo $pecah['nama_p'];?>" required="true">
					</div>
          <div class="form-group">
    ...
    <?php 
        if (isset($_POST['update']))
        {
          ...
          $path = "file dokumen/passport/".$nama_file;

          if(!empty($lokasi))
          {
            $koneksi->query("UPDATE passport SET nama_p='$_POST[p_nama]',
          ...
          {
            $koneksi->query("UPDATE passport SET nama_p='$_POST[p_nama]' WHERE id='$_GET[id]'");
          }  
          echo "<div class='alert alert-info'>Data Telah Diubah</div>";
          echo "<meta http-equiv='refresh' content='1;url=index_doc.php?halaman=pass'>";
        }  
      ?>
      <a href="index_doc.php?halaman=pass">
